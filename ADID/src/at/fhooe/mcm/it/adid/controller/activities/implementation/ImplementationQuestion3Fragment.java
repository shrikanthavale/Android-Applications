...
/**
 * This contains one section of Implementation. Level 3 of the implementation
 ...
 * 
 */
public class ImplementationQuestion3Fragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.fragment_implementation_question_3, container, false);
		...
		showQuestionButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mediaPlayerOptions.isPlaying()) {
					...
					speakOutButton.setText(ImplementationQuestion3Fragment.this
		...
		speakOutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (speakOutButton
						.getText()
						.toString()
						.equals(ImplementationQuestion3Fragment.this
								.getString(R.string.playbuttontext))) {
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreImplementationStateApplication.question3Answered) {
					Toast.makeText(
							ImplementationQuestion3Fragment.this.getActivity(),
	...
	private void initializeMediaPlayer() {
		...
		try {
			...
			if (locale.getLanguage().equalsIgnoreCase(
				...
				mediaPlayerQuestion.setDataSource(fileInputStreamQuestion
						.getFD());
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreImplementationStateApplication.question3Answered = true;
		...
		editor1.putBoolean(getString(R.string.implementation_quiz_3_answered), true);
		editor1.commit();	

		// check if all other questions are answered
		if (StoreImplementationStateApplication.question1Answered
				&& StoreImplementationStateApplication.question2Answered) {
