...
/**
 * This contains one section of Design. Level 2 of the design phase involves
 * closer to the unlocking feature.
 * 
 * @author Shrikant Havale
 * 
 */
public class DesignQuestion2Fragment extends Fragment {
...
/**
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_design_question_2,
				container, false);
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreDesignStateApplication.question2Answered) {
					Toast.makeText(DesignQuestion2Fragment.this.getActivity(),
	...
	private void showIncorrectAnswerDialogueBox() {
		...
		UtilityMethods.createAlertDialog(_title, _message,
				DesignQuestion2Fragment.this.getActivity());
	}
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreDesignStateApplication.question2Answered = true;
		...
		editor1.putBoolean(getString(R.string.design_quiz_2_answered), true);
		editor1.commit();

		// check if all other questions are answered
		if (StoreDesignStateApplication.question1Answered
				&& StoreDesignStateApplication.question3Answered) {
