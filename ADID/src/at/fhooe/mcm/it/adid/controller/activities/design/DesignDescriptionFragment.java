...
/**
 * This contains one section of Design. Description phase of the application. It
 * will contain text displaying the description, button for taking notes, and
 * image section for displaying features locked unlocked.
 * 
 * @author Shrikant Havale
 * 
 */
public class DesignDescriptionFragment extends Fragment {
...
//	private String notesReadFromFileStorage = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_design_description,
				container, false);
...
//								DesignDescriptionFragment.this.getActivity(), FOLDER_NAME,
...
//	}
	...
	public void updateImageViewFromOtherFragments() {
		...
		StoreDesignStateApplication.stageCleared = true;
