...
/**
 * This contains one section of Deployment. Level 3 of the Deployment phase
 ...
 * 
 */
public class DeploymentQuestion3Fragment extends Fragment implements
	 ...
	 */
	private static final String AUDIO_QUESTION_FILE_NAME = "question_3.mp3";

	/**
	 * mp3 file name storing in internal storage
	 */
	private static final String AUDIO_OPTION_FILE_NAME = "options_3.mp3";
	 ...
	 * mp3 file name in internal storage for storing audio
	 */
	private static final String AUDIO_QUESTION_FILE_NAME_DE = "question_3_de.mp3";

	/**
	 * mp3 file name storing in internal storage
	 */
	private static final String AUDIO_OPTION_FILE_NAME_DE = "options_3_de.mp3";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.fragment_deployment_question_3, container, false);
		...
		showQuestionButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mediaPlayerOptions.isPlaying()) {
					...
					speakOutButton.setText(DeploymentQuestion3Fragment.this
		...
		speakOutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (speakOutButton
						.getText()
						.toString()
						.equals(DeploymentQuestion3Fragment.this
								.getString(R.string.playbuttontext))) {
		...
		voiceInput.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!StoreDeploymentStateApplication.question3Answered) {
					// start voice recognition
					startVoiceRecognition();
				} else {
					textToSpeech
							.speak(getString(R.string.deploymentquestionalreadyanswered),
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreDeploymentStateApplication.question3Answered) {
					Toast.makeText(
							DeploymentQuestion3Fragment.this.getActivity(),
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreDeploymentStateApplication.question3Answered = true;
		SharedPreferences prefs1 = PreferenceManager
				.getDefaultSharedPreferences(getActivity()
						.getApplicationContext());
		Editor editor1 = prefs1.edit();
		editor1.putBoolean(getString(R.string.deployment_quiz_3_answered), true);
		editor1.commit();

		// check if all other questions are answered
		if (StoreDeploymentStateApplication.question1Answered
				&& StoreDeploymentStateApplication.question2Answered) {
	...
	private void sayCorrectAnswer() {
		...
		if (StoreDeploymentStateApplication.question1Answered
			...
			editor.putBoolean(getString(R.string.deployment_quiz_cleard), true);
			editor.commit();
			textToSpeech.speak(getString(R.string.sayallstagesclearedmessage),
					TextToSpeech.QUEUE_FLUSH, null);
		} else {
			textToSpeech.speak(getString(R.string.saydeploymentcorrectanswer),
					TextToSpeech.QUEUE_FLUSH, null);
		}
	...
	private void sayIncorrectAnswer() {
		textToSpeech.speak(getString(R.string.saydeploymentincorrectanswer),
				TextToSpeech.QUEUE_FLUSH, null);
	}
