...
/**
 * This contains one section of Design. Level 1 of the design phase involves
 * answering the question 1. Based on the correct answer users moves one step
 * closer to the unlocking feature.
 * 
 * @author Shrikant Havale
 * 
 */
public class DesignQuestion1Fragment extends Fragment {
...
/**
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_design_question_1,
				container, false);
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreDesignStateApplication.question1Answered) {
					Toast.makeText(DesignQuestion1Fragment.this.getActivity(),
	...
	private void showIncorrectAnswerDialogueBox() {
		...
		UtilityMethods.createAlertDialog(_title, _message,
				DesignQuestion1Fragment.this.getActivity());
	}
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreDesignStateApplication.question1Answered = true;
		...
		editor1.putBoolean(getString(R.string.design_quiz_1_answered), true);
		editor1.commit();
