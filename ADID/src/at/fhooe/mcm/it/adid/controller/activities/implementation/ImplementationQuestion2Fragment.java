...
/**
 * This contains one section of Implementation. Level 2 of the implementation
 ...
 * 
 */
public class ImplementationQuestion2Fragment extends Fragment implements
	 ...
	 */
	private static final String QUESTION_FILE_NAME = "question_2.txt";

	/**
	 * option file name in assets directory
	 */
	private static final String OPTIONS_FILE_NAME = "option_2.txt";

	/**
	 * wav file name in internal storage for storing audio
	 */
	private static final String AUDIO_QUESTION_FILE_NAME = "question_2.mp3";

	/**
	 * wav file name storing in internal storage
	 */
	private static final String AUDIO_OPTION_FILE_NAME = "options_2.mp3";
	
	/**
	 * question file name in assets directory
	 */
	private static final String QUESTION_FILE_NAME_DE = "question_2_de.txt";

	/**
	 * option file name in assets directory
	 */
	private static final String OPTIONS_FILE_NAME_DE = "option_2_de.txt";

	/**
	 * wav file name in internal storage for storing audio
	 */
	private static final String AUDIO_QUESTION_FILE_NAME_DE = "question_2_de.mp3";

	/**
	 * wav file name storing in internal storage
	 */
	private static final String AUDIO_OPTION_FILE_NAME_DE = "options_2_de.mp3";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.fragment_implementation_question_2, container, false);
		...
		mediaPlayerOptions.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mp) {
				...
				speakOutButton.setSelected(false);
			}
		});
		...
		showQuestionButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mediaPlayerOptions.isPlaying()) {
					...
					speakOutButton.setText(ImplementationQuestion2Fragment.this
		...
		speakOutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (speakOutButton
						.getText()
						.toString()
						.equals(ImplementationQuestion2Fragment.this
								.getString(R.string.playbuttontext))) {
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreImplementationStateApplication.question2Answered) {
					Toast.makeText(
							ImplementationQuestion2Fragment.this.getActivity(),
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreImplementationStateApplication.question2Answered = true;
		...
		editor1.putBoolean(getString(R.string.implementation_quiz_2_answered), true);
		editor1.commit();
		...
		disableRadioOptions();
		updateImageView();
		communicationInterface.notifyOtherFragmentsUpdateImageView(2);
	}
