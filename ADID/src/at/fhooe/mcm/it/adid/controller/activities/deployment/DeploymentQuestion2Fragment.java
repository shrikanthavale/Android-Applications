...
/**
 * This contains one section of Deployment. Level 2 of the Deployment phase
 ...
 * 
 */
public class DeploymentQuestion2Fragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.fragment_deployment_question_2, container, false);
		...
		showQuestionButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mediaPlayerOptions.isPlaying()) {
					...
					speakOutButton.setText(DeploymentQuestion2Fragment.this
		...
		speakOutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (speakOutButton
						.getText()
						.toString()
						.equals(DeploymentQuestion2Fragment.this
								.getString(R.string.playbuttontext))) {
		...
		radioGroup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (StoreDeploymentStateApplication.question2Answered) {
					Toast.makeText(
							DeploymentQuestion2Fragment.this.getActivity(),
	...
	private void showCorrectAnswerDialogueBox() {
		...
		StoreDeploymentStateApplication.question2Answered = true;
		...
		editor1.putBoolean(getString(R.string.deployment_quiz_2_answered), true);
		editor1.commit();
