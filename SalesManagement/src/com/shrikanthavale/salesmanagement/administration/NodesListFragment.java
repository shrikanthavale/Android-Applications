...
import com.shrikanthavale.salesmanagement.LoadNodeDescriptionAsync;
import com.shrikanthavale.salesmanagement.LoadNodeOptionsAsync;
...
public class NodesListFragment extends ListFragment {
	...
	private void showToast() {
		...
		Toast toast = Toast.makeText(this.getActivity(),
				"Data for the selected customer successfully loaded",
				Toast.LENGTH_SHORT);
